...
MAIN_URL = 'https://googledrive.com/host/0B4aCAaKzgvpYMzJxaTNLUk5GODQ/'
...
class FileFetcher(object):
    ...
    basePath = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.tvguide'))
    filePath = ''
    fileUrl = ''
    addon = None
    ...
    def fetchFile(self):
        ...
        if fetch:
            ...
            if os.path.getsize(tmpFile) > 256:
                ...
                xbmc.log('[script.tvguide] file %s was downloaded' % self.filePath, xbmc.LOGDEBUG)
            else:
